...
export default function DropdownMenu({ excludeLanguage, languageSelected }: { excludeLanguage: keyof EmojiCountryCodes, languageSelected: (language: keyof EmojiCountryCodes) => void }) {
