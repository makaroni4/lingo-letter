  ...
  return (
    <div className="fixed h-full top-0 right-0 bg-white w-1/3 z-30 pt-16 px-4 border-l-4 border-indigo-500">
      ...
      <div className="flex items-center mb-6">
        ...
        <div
          className="flex items-center p-1 border-[1px] border-slate-200 hover:border-slate-300 rounded-md cursor-pointer relative"
          ...
          { userLanguageMenuVisible && (
            <div
              className="absolute top-full left-0 flex items-center p-1 border-[1px] border-slate-200 hover:border-slate-300 rounded-md
      ...
      <div className="flex items-center">
        ...
        <div
          ...
          { emailLanguageMenuVisible && (
            <div className="absolute top-full left-0 flex items-center p-1 border-[1px] border-slate-200 hover:border-slate-300 rounded-md
            bg-white z-30 mt-[-4px] border-t-0">
              <LanguageMenu
